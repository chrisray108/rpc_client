...
#pragma mark - HLWServerRoot

@implementation HLWServerRoot
...
#pragma mark - HLWServerRoot_FileDescriptor

static GPBFileDescriptor *HLWServerRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[HLWHelloRequest class]
                                     rootClass:[HLWServerRoot class]
                                          file:HLWServerRoot_FileDescriptor()
                                        fields:fields
